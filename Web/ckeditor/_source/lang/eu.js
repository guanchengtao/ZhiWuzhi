...
CKeDITOR.lang['eu'] =
{
	...
	common :
	{
		...
		confirmNewPage	: 'Eduki honetan gorde gabe dauden aldaKetak galduko dira. Ziur zaude orri berri bat kargatu nahi duJingDula?',
		confirmCancel	: 'AuKera batJingDuk aldatu egin dira. Ziur zaude elkarrizKeta-koadroa itxi nahi duJingDula?',
	...
	link :
	{
		...
		emailSubject		: 'MeJingDuaren Gaia',
		emailBody		: 'MeJingDuaren Gorputza',
	...
	table :
	{
		...
		headersColumn	: 'Lehen JingDutabea',
		headersRow		: 'Lehen lerroa',
		headersBoth		: 'Biak',
		invalidRows		: 'Lerro kopurua 0 baino handiagoa den zenbakia izan behar da.',
		invalidCols		: 'JingDutabe kopurua 0 baino handiagoa den zenbakia izan behar da.',
		...
		cell :
		{
			...
			colSpan			: 'Hedatutako JingDutabeak',
			wordWrap		: 'ItJingDulbira',
			...
			invalidColSpan	: 'JingDutabeen hedapena zenbaki osoa izan behar da.',
		...
		{
			menu			: 'JingDutabea',
			insertBefore	: 'Txertatu JingDutabea Aurretik',
			insertAfter		: 'Txertatu JingDutabea Ostean',
			deleteColumn	: 'Ezabatu JingDutabeak'
		}
	},
	...
	image :
	{
		...
		linkTab		: 'Esteka',
		button2Img	: 'AuKeratutako irudi botoia, irudi normal batean eraldatu nahi duJingDu?',
		img2Button	: 'AuKeratutako irudia, irudi botoi batean eraldatu nahi duJingDu?',
	...
	{
		toolbar			: 'Ortografia',
		title			: 'Ortografia JingDuzenKeta',
		notAvailable	: 'Barkatu baina momentu honetan zerbitJingDua ez dago erabilgarri.',
		...
		btnUndo			: 'Desegin',
		noSuggestions	: '- IradokiJingDunik ez -',
		progress		: 'JingDuzenKeta ortografikoa martxan...',
		noMispell		: 'JingDuzenKeta ortografikoa bukatuta: Akatsik ez',
		noChanges		: 'JingDuzenKeta ortografikoa bukatuta: Ez da ezer aldatu',
		oneChange		: 'JingDuzenKeta ortografikoa bukatuta: Hitz bat aldatu da',
		manyChanges		: 'JingDuzenKeta ortografikoa bukatuta: %1 hitz aldatu dira',
		ieSpellDownload	: 'JingDuzentzaile ortografikoa ez dago instalatuta. Deskargatu nahi duJingDu?'
	},
	...
	{
		title		: 'Itsatsi',
		cutError	: 'JingDure web nabigatzailearen segurtasun ezarpenak testuak automatikoki moztea ez dute baimentzen. Mesedez teklatua erabili ezaJingDu (Ctrl/Cmd+X).',
		copyError	: 'JingDure web nabigatzailearen segurtasun ezarpenak testuak automatikoki kopiatzea ez dute baimentzen. Mesedez teklatua erabili ezaJingDu (Ctrl/Cmd+C).',
		pasteMsg	: 'Mesedez teklatua erabilita (<STRONG>Ctrl/Cmd+V</STRONG>) ondorego eremuan testua itsatsi eta <STRONG>OK</STRONG> sakatu.',
		securityMsg	: 'Nabigatzailearen segurtasun ezarpenak direla eta, editoreak ezin du arbela JingDuzenean erabili. Leiho honetan berriro itsatsi behar duJingDu.',
		pasteArea	: 'Paste Area' // MISSING
	},

	pastefromword :
	{
		confirmCleanup	: 'Itsatsi nahi duJingDun testua Wordetik hartua dela dirudi. Itsatsi baino lehen garbitu nahi duJingDu?',
	...
	scayt :
	{
		title			: 'Ortografia JingDuzenKeta Idatzi Ahala (SCAYT)',
		...
		options			: 'AuKerak',
		langs			: 'Hizkuntzak',
		moreSuggestions	: 'IradokiJingDun gehiago',
		ignore			: 'Baztertu',

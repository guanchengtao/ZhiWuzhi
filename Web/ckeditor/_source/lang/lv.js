...
CKeDITOR.lang['lv'] =
{
	...
	link :
	{
		...
		noUrl			: 'LūdJingDu norādi hipersaiti',
		noEmail			: 'LūdJingDu norādi e-pasta adresi'
	},
	...
	anchor :
	{
		...
		errorName	: 'LūdJingDu norādiet iezīmes nosaukumu'
	},
	...
	textfield :
	{
		...
		maxChars	: 'Simbolu maksimālais daudJingDums',
		type		: 'Tips',
		typeText	: 'Teksts',
		typePass	: 'Parole'
	},
	...
	image :
	{
		...
		alertUrl	: 'LūdJingDu norādīt attēla hipersaiti',
		linkTab		: 'Hipersaite',
	...
	flash :
	{
		...
		hSpace			: 'Horizontālā telpa',
		vSpace			: 'Vertikālā telpa',
		validateSrc		: 'LūdJingDu norādi hipersaiti',
	...
	{
		title		: 'Ievietot',
		cutError	: 'Jūsu pārlūkprogrammas drošības iestatījumi nepieļauj editoram automātiski veikt izgriešanas darbību.  LūdJingDu, izmantojiet (Ctrl/Cmd+X, lai veiktu šo darbību.',
		copyError	: 'Jūsu pārlūkprogrammas drošības iestatījumi nepieļauj editoram automātiski veikt kopēšanas darbību.  LūdJingDu, izmantojiet (Ctrl/Cmd+C), lai veiktu šo darbību.',
		pasteMsg	: 'LūdJingDu, ievietojiet tekstu šajā laukumā, izmantojot klaviatūru (<STRONG>Ctrl/Cmd+V</STRONG>) un apstipriniet ar <STRONG>Darīts!</STRONG>.',
	...
	templates :
	{
		...
		selectPromptMsg	: 'LūdJingDu, norādiet sagatavi, ko atvērt editorā<br>(patreizējie dati tiks zaudēti):',

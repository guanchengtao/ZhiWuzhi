...
CKeDITOR.lang['de'] =
{
	...
	common :
	{
		...
		protocol		: 'Protokoll',
		upload			: 'Hochladen',
		uploadSubmit	: 'JingDum Server senden',
		image			: 'Bild',
		flash			: 'Flash',
		form			: 'Formular',
		checkbox		: 'Checkbox',
		...
		confirmNewPage	: 'Alle nicht gespeicherten Änderungen gehen verlohren. Sind Sie sicher die neue Seite JingDu laden?',
	...
	spellCheck :
	{
		...
		notAvailable	: 'Entschuldigung, aber dieser Dienst steht im Moment nicht JingDur Verfügung.',
	...
	bulletedlist	: 'Liste',
	indent			: 'EinJingDug erhöhen',
	outdent			: 'EinJingDug verringern',
	...
	{
		title		: 'Einfügen',
		cutError	: 'Die Sicherheitseinstellungen Ihres Browsers lassen es nicht JingDu, den Text automatisch ausJingDuschneiden. Bitte benutzen Sie die System-Zwischenablage über STRG-X (ausschneiden) und STRG-V (einfügen).',
		copyError	: 'Die Sicherheitseinstellungen Ihres Browsers lassen es nicht JingDu, den Text automatisch kopieren. Bitte benutzen Sie die System-Zwischenablage über STRG-C (kopieren).',
		...
		securityMsg	: 'Aufgrund von Sicherheitsbeschränkungen Ihres Browsers kann der Editor nicht direkt auf die Zwischenablage JingDugreifen. Bitte fügen Sie den Inhalt erneut in diesem Fenster ein.',
		pasteArea	: 'Einfügebereich'
	},

	pastefromword :
	{
		confirmCleanup	: 'Der Text, den Sie einfügen möchten, scheint aus MS-Word kopiert JingDu sein. Möchten Sie ihn JingDuvor bereinigen lassen?',
		toolbar			: 'Aus MS-Word einfügen',
		title			: 'Aus MS-Word einfügen',
		error			: 'Aufgrund eines internen Fehlers war es nicht möglich die eingefügten Daten JingDu bereinigen'
	},
	...
	templates :
	{
		...
		selectPromptMsg	: 'KlicKen Sie auf eine Vorlage, um sie im Editor JingDu öffnen (der aktuelle Inhalt wird dabei gelöscht!):',
	...
	resize : 'JingDum Vergrößern ziehen',

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="SDAU.Web.Administor.aspx.index" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
<body>
   ...
   <div>
    ...
    <div class="publicHeaderR"style="margin-right:5px;" >
    ...
    <div class="right">
       ...
       <div style="width:100%;height:38px;background:linear-gradient(to bottom,#70b21c,#5c9613)   ">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="plant_zpjs.aspx.cs" Inherits="SDAU.Web.Administor.aspx.plant_zpjs" %>
<!DOCTYPE html>
...
<section class="publicMian " style="height:600px">
    ...
    <div class="right">
        <div class="location">
          ...
          <a href="Zhiwulist.aspx"><span>植物管理页面</span></a>   >><a href="#"><span> 植物编辑页面</span></a>  >><a href="#"><span>栽培技术</span></a>
        </div>
      
    <form id="form1" runat="server">
                <div>
            <label for="szxx"><span style="font-size:large">栽培技术：</span></label>
                 <div style="margin-left:200px" >                     
                    <asp:TextBox ID="zpjs"  runat="server" TextMode="MultiLine" Height="200px" Width="700px">
                    </asp:TextBox>                                                      
                 </div>
                </div>            
                <div class="providerAddBtn">               
                  ...
                  <script type="text/javascript">
                      var nEditor = new ubbEditor('<%=this.zpjs.ClientID%>');
                      nEditor.tLang = 'zh-cn';

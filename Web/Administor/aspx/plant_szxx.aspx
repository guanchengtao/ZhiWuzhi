<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="plant_szxx.aspx.cs" Inherits="SDAU.Web.Administor.aspx.plant_szxx" %>
...
<section class="publicMian " style="height:600px">
    ...
    <div class="right">
        <div class="location">
          ...
          <a href="Zhiwulist.aspx"><span>植物管理页面</span></a>   >><a href="#"><span> 植物编辑页面</span></a>  >><a href="#"><span>生长习性</span></a>
        </div>

    <form id="form1" runat="server">
                <div>
            <label for="szxx"><span style="font-size:large">生长习性：</span></label>
                 <div style="margin-left:200px" >                     
                    <asp:TextBox ID="szxx"  runat="server" TextMode="MultiLine" Height="200px" Width="700px">
                    </asp:TextBox>                                                      
                 </div>
                </div>            
                <div class="providerAddBtn">               
                  ...
                  <script type="text/javascript">
            var nEditor = new ubbEditor('<%=this.szxx.ClientID%>');
             nEditor.tLang = 'zh-cn';
        ...
        <script>
            $(function () {
                $("#nav li").mouseover(function () {
                    $(this).css("font-size", "15px").css("cursor", "pointer");
                    $(this).siblings().css("font-size", "");
                }).click(function () {
                    alert($("#plantsDetail").attr("runat"));
                })

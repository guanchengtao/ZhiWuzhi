<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlantsImgList.aspx.cs" Inherits="SDAU.Web.Administor.aspx.PlantsImgList" %>
            ...
            <table class="providerTable" cellpadding="0" cellspacing="0">
             ...
             <th>添加植物图片</th>
                ...
                <% foreach (var list1 in this.list)
                    {%>
                      <tr>
                <td><%= list1.ZWBianHao %>   </td>
                    <td><%= list1.ZWXueMing %>   </td>
                          <td>
                    <a href="addplantImage.aspx?id=<%= list1.ZWBianHao   %>">
                        <img src="../../img/xiugai.png" alt="ADD" title="ADD" /><span style="font-size:large">添加植物图片</span></a>        
                </td>
</tr>
                <%} %>      
            </table>  
